...
export PYTHONPATH="/opt/jsk/System/ros1_dependencies/lib/python2.7/dist-packages:${PYTHONPATH}"
...
export PYTHONPATH="/opt/jsk/System/Python/lib/python2.7/dist-packages:${PYTHONPATH}"
